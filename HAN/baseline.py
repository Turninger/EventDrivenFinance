...
train_npy = np.load(dataPath + '/dataloader/train_bert_np_full_1.npy') # [n * seq_len * max_news * embedded_size]
cv_npy = np.load(dataPath + '/dataloader/cv_bert_np_full_1.npy')
test_npy = np.load(dataPath + '/dataloader/test_bert_np_full_1.npy')
